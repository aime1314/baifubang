	...
	<view>		
		<view class="form-box">
			<view class="form-area set_bor">
				...
				<label class="radio"><radio class="cart_radio" value="r1" color="#ED6C1B" /></label>
			</view>
			<view class="form-area set_bor">
				<view class="label">新品上市</view>
				<label class="radio"><radio class="cart_radio" value="r1" color="#ED6C1B" /></label>
			</view>
			<view class="form-area set_bor">
		...
		<!-- <view class="set_foot">
			<view class="set_btn_a">上架出售</view>
			<view class="set_btn_n">放入仓库</view>
		</view> -->
	</view>
